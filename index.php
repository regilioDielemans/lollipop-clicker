...
<div class="pop_up_candy_store">
	...
	<form action="controller/sitecontroller.php" method="POST"><input type="text" class="pop_up_candy_store_input"><a href="randomNameGenerator.php"><input type="button" value="Name generator" class="btn btn-danger"></a><input type="submit" value="Get started" class="btn submit_name_button btn-danger"></form>
</div>
